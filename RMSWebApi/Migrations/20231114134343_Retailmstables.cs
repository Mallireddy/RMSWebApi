        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GenereId = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PurchaseOrders_BooKs_BookId",
                        column: x => x.BookId,
                        principalTable: "BooKs",
                        principalColumn: "BookId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Genres_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "OrderId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Genres_PurchaseOrders_PurchaseOrderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Genres_OrderId",
                table: "Genres",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_Genres_PurchaseOrderId",
                table: "Genres",
